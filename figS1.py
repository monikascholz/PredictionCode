...
# plot manifolds for all datasets - moving and immobile
index = 0
...
#    colorBy = np.zeros(len(x))
#    ax = plt.subplot(gs1[index], projection='3d')
#    plotManifoooold(x,y,z,colorBy, ax)
#    index+=1
#    
#
#    x,y,z = results['pcaComponents'][:3]
#    colorBy = np.ones(len(x))
#    ax = plt.subplot(gs1[index], projection='3d')
#    plotManifoooold(x,y,z,colorBy, ax)
#    index+=1
plt.show()
