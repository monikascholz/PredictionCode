...
fig = plt.figure('Fig1_Neural dynamics in freely moving animals', figsize=(9.5, 4.5))
gsHeatmap = gridspec.GridSpec(5,4,  width_ratios=[1.5, 0.1, 0.5, 0.5], height_ratios = [0.05,0.95,0.1,0.75,0.05])
...
# manifooolds
gsPer1= gridspec.GridSpecFromSubplotSpec(1, 2, subplot_spec=gsHeatmap[3:,2:], wspace=0.35,hspace=0.2)#, height_ratios=[1,1.25])
...
moveAxes(ax5, 'up', -0.03)
moveAxes(ax6, 'up', -0.03)
plt.show()
